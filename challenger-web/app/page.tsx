...
// ✅ 여기에 public/sponsors/marquee 안 파일명 맞춰서 넣어
    ...
    <div className={`min-h-screen bg-black text-white ${inter.className}`}>
      ...
      <nav className="fixed w-full z-50 bg-black/90 backdrop-blur-md border-b border-zinc-900">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          {/* ✅ Contact 버튼도 가운데 정렬되게 items-center */}
          ...
          <div className="rounded-[32px] border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] shadow-[0_30px_80px_rgba(0,0,0,0.65)] overflow-hidden">
            <ul className="divide-y divide-white/10">
              ...
              <li className="group px-6 md:px-12 py-8 flex items-center gap-5 md:gap-7">
                <Link
                  href="/specs/2025"
                  className="hidden sm:block w-56 h-36 md:w-64 md:h-40 rounded-3xl overflow-hidden
                            border border-white/15 bg-black/40 shrink-0
                ...
                <div className="w-14 md:w-20 shrink-0 text-white/70 font-black text-lg md:text-xl">
                  2025
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 text-sm md:text-base text-gray-400">
                    KSAE Formula Student Korea
                  </div>
                </div>

                <span className="shrink-0 px-4 py-2 rounded-full text-xs font-black
                                border border-[#950000]/40 bg-[#950000]/15 text-white">
                  GOLD
                </span>
              </li>
              ...
              <li className="group px-6 md:px-12 py-8 flex items-center gap-5 md:gap-7">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 text-sm md:text-base text-gray-400">
                    0-100 km/h <span className="text-white font-black">3.01 s</span>
                  </div>
                </div>
      ...
      {/* 5. Sponsors (중앙 오버레이 + 뒤에서 로고 무한 슬라이드) */}
      <section id="sponsors" className="py-28 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          {/* 로고 슬라이드 박스 */}
          <div className="relative rounded-[32px] border border-white/10
                          bg-gradient-to-b from-white/[0.06] to-white/[0.02]
                          overflow-hidden shadow-[0_30px_90px_rgba(0,0,0,0.65)]">
            ...
            {/* ✅ 앞쪽: 중앙 오버레이 (텍스트/버튼이 정중앙) */}
            <div className="absolute inset-0 flex items-center justify-center">
              {/* 흐림/어둡게 깔아주기 (글씨 잘 보이게) */}
                ...
                <div className="mt-7 pointer-events-auto">
                  <Link
                    ...
                    className="inline-flex items-center justify-center px-7 py-3 rounded-full
                              ...
                              hover:bg-[#950000] hover:text-white transition"
                  >
                    SHOW LIST
                  </Link>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="flex gap-4 mt-8">
              <a
                ...
                className="p-3 bg-zinc-900 rounded-full hover:bg-[#950000] transition text-white"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          <div className="flex flex-col gap-4">
            <div className="h-96 bg-zinc-900 rounded-xl overflow-hidden border border-zinc-800">
              <iframe
                title="Hoseo University Asan Campus - 2nd Engineering Building B10"
            ...
            <div className="flex justify-end">
              <a
                href="https://www.google.com/maps?q=%ED%98%B8%EC%84%9C%EB%8C%80%ED%95%99%EA%B5%90%20%EC%95%84%EC%82%B0%EC%BA%A0%ED%8D%BC%EC%8A%A4%20%EC%A0%9C2%EA%B3%B5%ED%95%99%EA%B4%80%20B10%ED%98%B8"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5
                           rounded-full border border-white/15
                           bg-white/5 text-sm font-bold text-white
                           hover:bg-[#950000] hover:border-[#950000]
                           transition"
              >
                Open in Google Maps
              </a>
