    ...
    points: [
      {
        ...
        desc: "고전압 시스템의 절연, 프리차지, 비상 차단, BMS를 포함한 하나의 안전 구조로 설계하여 차량과 드라이버를 보호합니다.",
      },
      {
        title: "Reliable Energy Delivery",
        desc: "배터리 시스템과 BMS를 기반으로 에너지 사용을 관리하고, 전력 전달 경로와 열 특성을 최적화하여 고출력 주행에서도 안정적인 에너지 공급을 보장합니다.",
      },
    ],
  },
  {
