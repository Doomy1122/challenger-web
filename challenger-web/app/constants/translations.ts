export const translations = {
  ...
  en: {
    ...
    about: {
      ...
      vision_title: "Our Vision",
      vision_desc: "Prove with results, Grow through the process.\n\nWe prove our skills with results on the track. \nSimultaneously, we grow together into future leaders of the automotive industry by mastering professional engineering tools like Ansys, Catia, and MATLAB.",
    },
    history: {
      label: "Latest Achievements",
      title: "Awards & Records",
